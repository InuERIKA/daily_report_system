...
public class EmployeeConverter {
	...
	public static Employee toModel(EmployeeView ev) {
		...
		return new Employee(
				...
				ev.getAdminFlag() == null
						? null
						: ev.getAdminFlag() == AttributeConst.ROLE_ADIN.getIntegerValue()
								? JpaConst.ROLE_ADMIN
	...
	public static EmployeeView toView(Employee e) {
		...
		return new EmployeeView(
				...
				e.getAdminFlag() == null
						? null
						: e.getAdminFlag() == JapConst.ROLE_ADMIN
								? AttributeConst.ROLE_ADMIN.getIntegerValue()
								: AttributeConst.ROLE_GENERL.getIntegerValue(),
				e.getCreatedAt(),
				e.getUpdatedAt(),
				e.getDeleteFlag() == null
						? null
						: e.getDeleteFlag() == JapConst.EMP_DEL_TRUE
								? AttributeConst.DEL_FLAG_TRUE.getIntegerValue()
								: AttributeConst.DEL_FLAG_FLSE.getIntegerValue());
	}
